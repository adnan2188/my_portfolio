    ...
    return (
        <section className="services section" id="services">
            ...
            <div className="services_container container grid">
                ...
                <div className="services_content">
                    ...
                    <div className={toggleState === 1 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            <i onClick={() => toggleTab(0)} className="uil uil uil-times services_modal-clos"></i>
                            <h3 className="services_modal-title">Product Designer</h3>
                            <p className="services_modal-descriprion">
                                Services with more than 3 years of experience.
                                Providing quality work to clients and companies.
                            </p>
                            <ul className="services_moda n l-services grid">
                ...
                <div className={toggleState === 1 ? "services_content active-modal" : "services_content"}>
                    {/* <div className="services_content"> */}
                    ...
                    <div className={toggleState === 2 ? "services_modal active-modal" : "services_modal"}>
                        <div className="services_modal-content">
                            <i onClick={() => toggleTab(0)} className="uil uil-times services_modal-clos"></i>
                ...
                <div className={toggleState === 2 ? "services_content active-modal" : "services_content"}>
